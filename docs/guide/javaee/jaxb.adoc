...
JAXB support is provided through the https://github.com/apache/camel/blob/camel-{camel-version}/components/camel-jaxb/src/main/docs/jaxb-component.adoc[Camel JAXB data format,window=_blank].
