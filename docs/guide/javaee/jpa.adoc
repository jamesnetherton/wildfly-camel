...
JPA integration is provided by the https://github.com/apache/camel/blob/camel-{camel-version}/components/camel-jpa/src/main/docs/jpa-component.adoc[Camel JPA component,window=_blank].
