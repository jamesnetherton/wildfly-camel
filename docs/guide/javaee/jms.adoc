...
Messaging support is provided through the https://github.com/apache/camel/blob/camel-{camel-version}/components/camel-jms/src/main/docs/jms-component.adoc[JMS,window=_blank]
