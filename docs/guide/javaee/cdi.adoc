...
For more information about CDI, refer to the https://github.com/apache/camel/blob/camel-{camel-version}/components/camel-cdi/src/main/docs/cdi-component.adoc[cdi,window=_blank] documentation.
