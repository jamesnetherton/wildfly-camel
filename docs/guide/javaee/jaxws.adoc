...
WebService support is provided through the https://github.com/apache/camel/blob/camel-{camel-version}/components/camel-cxf/src/main/docs/cxf-component.adoc[CXF,window=_blank]
