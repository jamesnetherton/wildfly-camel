...
Secure message exchanges in camel is provided by the https://github.com/apache/camel/blob/camel-{camel-version}/components/camel-crypto-digital-signatures/src/main/docs/crypto-digital-signatures-component.adoc[crypto,window=_blank] component.
