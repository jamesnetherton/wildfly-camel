...
This https://github.com/apache/camel/blob/camel-{camel-version}/components/camel-infinispan/src/main/docs/infinispan-component.adoc[infinispan,window=_blank]
