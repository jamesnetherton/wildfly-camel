...
project version 4. Therefore, the standard https://github.com/apache/camel/blob/camel-{camel-version}/components/camel-netty/src/main/docs/netty-component.adoc[netty component,window=_blank] will not work since it is compatible with Netty version 3 only.
