...
component allows you to define REST endpoints using the https://github.com/apache/camel/blob/camel-{camel-version}/components/camel-rest-dsl/src/main/docs/rest-dsl-component.adoc[Rest DSL,window=_blank] and plugin to other Camel components as the REST transport.
