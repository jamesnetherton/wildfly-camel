...
The https://github.com/apache/camel/blob/camel-{camel-version}/components/camel-undertow/src/main/docs/undertow-component.adoc[undertow,window=_blank]
...
include::camel-undertow-differences.adoc[]
