...
Atom feed consumption in Camel is provided by the https://github.com/apache/camel/blob/camel-{camel-version}/components/camel-atom/src/main/docs/atom-component.adoc[atom,window=_blank] component.
