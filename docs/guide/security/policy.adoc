...
Camel supports the notion of https://github.com/apache/camel/blob/camel-{camel-version}/components/camel-routepolicy/src/main/docs/routepolicy-component.adoc[RoutePolicies,window=_blank], which can be used to integrate with the {wildfly} security system. There are currently two supported scenarios for security integration.
