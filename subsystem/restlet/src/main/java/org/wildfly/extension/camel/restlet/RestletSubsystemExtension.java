...
public class RestletSubsystemExtension implements CamelSubsytemExtension {

    @Override
    public Component resolveComponent(String name, SubsystemState subsystemState) {
        if (name.equals("restlet")) {
            return new WildFlyRestletComponent(new org.restlet.Component());
        }
        return null;
    }
}
